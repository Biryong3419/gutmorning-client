            ...
            <main>
                ...
                <section id="hero" className="wow fadeIn">
                    <div className="hero-container">
	                    ...
	                    <h3>&nbsp;</h3>
                        <h2>{lines}</h2>
                        <img src={require('../img/hero-img.png')} alt="Hero Imgs"/>
	                        ...
	                        <div className="container">
	                            <div className="section-title text-center">
	                                <div className="col-12">
	                                    <img className="advanced-feature-img-right wow fadeInRight" src={require('../img/calendar.png')} alt=""/>
                        ...
                        <div className="modal-dialog">
                            <div className="modal-content">
                                ...
                                <div className="modal-body">
                                    <img src={require('../img/svg/bio_popup.svg')} alt="img" className="img-biopopup"/>
                                </div>
                        ...
                        <div className="row">
                            <div className="col-md-6 col-lg-3">
                                <div className="feature-block">
                                    <img src={require('../img/svg/1.svg')} alt="img" className="img-fluid"/>
                            ...
                            <div className="col-md-6 col-lg-3">
                                <div className="feature-block">
                                    <img src={require('../img/svg/2.svg')} alt="img" className="img-fluid"/>
                            ...
                            <div className="col-md-6 col-lg-3">
                                <div className="feature-block">
                                    <img src={require('../img/svg/3.svg')} alt="img" className="img-fluid"/>
                            ...
                            <div className="col-md-6 col-lg-3">
                                <div className="feature-block">
                                    <img src={require('../img/svg/4.svg')} alt="img" className="img-fluid"/>
                ...
                <section id="screenshots" className="padd-section text-center wow fadeInUp">
                    ...
                    <div className="container">
                        <div className="owl-carousel owl-theme">
                            <div><img src={require('../img/screen/1.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/2.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/3.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/4.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/5.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/6.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/7.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/8.jpg')} alt="img"/></div>
                            <div><img src={require('../img/screen/9.jpg')} alt="img"/></div>
                        </div>
                    </div>
